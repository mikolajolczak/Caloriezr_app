    ...
    return (
      <View style={[styles.container, style]} {...restProps}>
        ...
        {!indeterminate && showsText ? (
          ...
          >{formatText(progressValue).includes('&')?<View>
          <Text
            style={[
              {
                color,
          ...
          >
            {formatText(progressValue).substr(0,formatText(progressValue).indexOf('&'))}
          </Text>
          <Text style={[
              {
                color,
            ...
            allowFontScaling={allowFontScaling}>{formatText(progressValue).slice(formatText(progressValue).indexOf('&')+1)}</Text>
          </View>:<Text
            style={[
              {
                color,
